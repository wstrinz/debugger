...
describe Debugger::IdeControlCommandProcessor do
  include TestDsl

  let(:klass) { Debugger::IdeControlCommandProcessor }
  ...
  temporary_change_method_value(Debugger, :handler, Debugger::IdeProcessor.new(TestInterface.new))
